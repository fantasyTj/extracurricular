...
def make_glookup(class_assignments):
    ...
    """
    "*** YOUR CODE HERE ***"
    earned_score, total_score = 0, 0
    def glookup(keyword, score):
        nonlocal earned_score, total_score
        earned_score += score
        total_score += class_assignments[keyword]
...
def make_advanced_counter_maker():
    ...
    def make_counter():
        personal_balance = 0
        def counter(keyword):
            nonlocal global_balance, personal_balance
            "*** YOUR CODE HERE ***"
            # as many lines as you want
            if keyword == 'count':
                personal_balance += 1
                print(personal_balance)
            elif keyword == 'global-count':
                global_balance += 1
                print(global_balance)
            elif keyword == 'reset':
                personal_balance = 0
            elif keyword == 'global-reset':
                global_balance = 0
        return counter
    return make_counter
